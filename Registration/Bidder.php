...
if (isset($_POST['signup'])) {
	...
	if ($password == $cpassword) {
		...
		if ($photo_size > 5242880) {
			...
			$sql = "SELECT * FROM bidder WHERE Email='$email'";
			$result = mysqli_query($conn, $sql);

			if (!$result->num_rows > 0) {

				$sql = "INSERT INTO bidder (Username, Email, Password, Image)
						VALUES ('$username', '$email', '$password',  '$photo_new_name')";
				$result = mysqli_query($conn, $sql);

				if ($result) {

					move_uploaded_file($photo_tmp_name, "../Images/Bidder/" . $photo_new_name);


					echo "<script>alert('Wow! Bidder Registration Completed.')</script>";
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Sign up - Bidder</h2>
						<form method="POST" class="register-form" id="register-form">
							...
							<div>
                                <a href="Seller.php">Sign up as Seller</a>
                            </div>
						</form>
					</div>
					<div class="signup-image">
						<figure><img src="../images/signup-image.jpg" alt="sing up image"></figure>
						<a href="../Bidder.php" class="signup-image-link">I am already member</a>
					</div>
				</div>
			</div>
		</section>
        ...
        <div class="container">
            ...
            <div class="parentdesc">
                <div class="description">
                    ...
                    <a href="../Login/Bidder.php">Sign In</a>
                 </div>
              </div>
        </div>
